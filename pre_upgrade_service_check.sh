...
# Script will pull all services installed on the cluster and initiate a bulk service check. 
# Only service check that is not covered here is "Kerberos Service Check"
